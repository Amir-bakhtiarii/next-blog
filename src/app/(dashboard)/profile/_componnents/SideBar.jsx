...
function SideBar({ onClose }) {
  ...
  return (
    <div className="bg-white overflow-y-auto flex flex-col p-5 h-screen pt-10 lg:pt-8">
      {/* Sidebar header */}
      <div className="flex items-center justify-between w-full mb-5 pb-2 border-b-secondary-900">
        <Link
          href="/"
